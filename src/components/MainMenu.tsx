...
export const MainMenu = function({ target }: Props) {
    return (
        <nav class="container-fluid topnav">
            <ul>
                <li><a class="contrast fixed" href="{baseURL}/"><img id="navbar-sol" src="{baseURL}/media/sol.png" alt="sol" /></a></li>
            ...
            <ul>
                ...
                <li><a class={target === "docs" ? "contrast" : "secondary"} href="{baseURL}/docs/{docsCurrentVersion}">Docs</a></li>
